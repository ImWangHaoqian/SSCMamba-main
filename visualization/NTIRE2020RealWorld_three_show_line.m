%% Plot Spectral Curves Comparison for ARAD_HS_0463 (NTIRE2020_realworld)
% This script generates spectral curves comparison for 14 methods (including GT)
% Similar to show_line.m but adapted for NTIRE2020_realworld dataset
...
% For NTIRE2020_realworld, data should have 31 channels matching lam31
...
if actual_num_channels == length(lam31)
    ...
    % Estimate wavelengths: 400nm to 700nm range (NTIRE2020_realworld)
...
output_figure_path = fullfile(output_base_dir, 'spectral_comparison_ARAD_HS_0463.png');

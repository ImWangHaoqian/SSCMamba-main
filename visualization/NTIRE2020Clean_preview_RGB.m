%% Preview RGB Images from NTIRE2020_clean Dataset
...
% Data directory
data_dir = fullfile(script_dir, '..', '..', '..', 'exp', 'NTIRE2020_clean', 'edsr');
...
% RGB channels for NTIRE2020_clean: R=650nm (ch26), G=550nm (ch16), B=450nm (ch6)
...
% Create figure
fig = figure('Name', 'RGB Previews - NTIRE2020_clean', ...
    'NumberTitle', 'off', ...
